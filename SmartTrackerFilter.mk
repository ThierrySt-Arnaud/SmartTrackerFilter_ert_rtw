...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SmartTrackerFilter
...
PRODUCT_NAME              = SmartTrackerFilter
MAKEFILE                  = SmartTrackerFilter.mk
COMPUTER                  = MACI64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/thierry/Documents/MATLAB/smarttracker
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SmartTrackerFilter
...
DEFINES_STANDARD = -DMODEL=SmartTrackerFilter -DNUMST=4 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
%.o : $(START_DIR)/SmartTrackerFilter_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SmartTrackerFilter_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
